...
public class Transactions extends JFrame implements ActionListener{
    ...
    Transactions(){
        ...
        l1.setBounds(110,50,700,40);
        getContentPane().add(l1);
        
        b1.setBounds(40,140,300,60);
        getContentPane().add(b1);
        
        b2.setBounds(440,140,300,60);
        getContentPane().add(b2);
        
        b3.setBounds(40,220,300,60);
        getContentPane().add(b3);
        
        b4.setBounds(440,220,300,60);
        getContentPane().add(b4);
        
        b5.setBounds(40,300,300,60);
        getContentPane().add(b5);
        
        b6.setBounds(440,300,300,60);
        getContentPane().add(b6);
        
        b7.setBounds(240,380,300,60);
